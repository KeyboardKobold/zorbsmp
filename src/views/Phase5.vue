<template>
    <div class="content">
        <h4>ZorbSMP Phase 5</h4>
        <p>
            The minecraft survial experience known as ZorbSMP has returned since the 12th July 2022. <br/>
            It will be running for approximately one month. Extensions are possible if enough people keep playing.
        </p>
        <h4>How to play</h4>
        <p>
            <ul>
